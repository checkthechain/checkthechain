...
# sources:
# - https://github.com/duneanalytics/spellbook/blob/main/models/addresses/ethereum/addresses_ethereum_cex.sql
ethereum_cexes = [
    ...
    ('0xd688aea8f7d450909ade10c47faa95707b0682d9', 'Coinbase', 'Coinbase 7'),
    ('0x02466e547bfdab679fc49e96bbfc62b9747d997c', 'Coinbase', 'Coinbase 8'),
    ...
    ('0xcba38020cd7b6f51df6afaf507685add148f6ab6', 'OKX', 'OKX 8'),
    ('0x461249076b88189f8ac9418de28b365859e46bfd', 'OKX', 'OKX 9'),
    ('0xc5451b523d5fffe1351337a221688a62806ad91a', 'OKX', 'OKX 10'),
    ('0x42436286a9c8d63aafc2eebbca193064d68068f2', 'OKX', 'OKX 11'),
    ('0x69a722f0b5da3af02b4a205d6f0c285f4ed8f396', 'OKX', 'OKX 12'),
    ('0xc708a1c712ba26dc618f972ad7a187f76c8596fd', 'OKX', 'OKX 13'),
    ('0x6fb624b48d9299674022a23d92515e76ba880113', 'OKX', 'OKX 14'),
    ('0xf59869753f41db720127ceb8dbb8afaf89030de4', 'OKX', 'OKX 15'),
    ('0x65a0947ba5175359bb457d3b34491edf4cbf7997', 'OKX', 'OKX 16'),
    ...
    ('0xa83b11093c858c86321fbc4c20fe82cdbd58e09e', 'Kraken', 'Kraken 14'),
    ...
    ('0x1b8766d041567eed306940c587e21c06ab968663', 'Bitfinex', 'Bitfinex 14'),
    ('0x5a710a3cdf2af218740384c52a10852d8870626a', 'Bitfinex', 'Bitfinex 15'),
    ('0x28140cb1ac771d4add91ee23788e50249c10263d', 'Bitfinex', 'Bitfinex 16'),
    ('0x53b36141490c419fa27ecabfeb8be1ecadc82431', 'Bitfinex', 'Bitfinex 17'),
    ('0x0cd76cd43992c665fdc2d8ac91b935ca3165e782', 'Bitfinex', 'Bitfinex 18'),
    ('0xe92d1a43df510f82c66382592a047d288f85226f', 'Bitfinex', 'Bitfinex 19'),
    ('0x8103683202aa8da10536036edef04cdd865c225e', 'Bitfinex', 'Bitfinex 20'),
    ...
    ('0x7758e507850da48cd47df1fb5f875c23e3340c50', 'Crypto.com', 'Crypto.com 4'),
    ('0xcffad3200574698b78f32232aa9d63eabd290703', 'Crypto.com', 'Crypto.com 5'),
    ...
    ('0xaf1931c20ee0c11bea17a41bfbbad299b2763bc0', 'Luno', 'Luno 1'),
    ...
    ('0x75e89d5979e4f6fba9f97c104c2f0afb3f1dcb88', 'MEXC', 'MEXC 1'),
    ('0x0211f3cedbef3143223d3acf0e589747933e8527', 'MEXC', 'MEXC 2'),
    ('0x3cc936b795a188f0e246cbb2d74c5bd190aecf18', 'MEXC', 'MEXC 3'),
    ('0xf5bec430576ff1b82e44ddb5a1c93f6f9d0884f3', 'Yobit', 'Yobit 1'),
    ...
    ('0x28c9386ebab8d52ead4a327e6423316435b2d4fc', 'RenrenBit', 'RenrenBit'),
    ('0x1fd6267f0d86f62d88172b998390afee2a1f54b6', 'Exmo', 'Exmo 1'),
    ('0xd7b9a9b2f665849c4071ad5af77d8c76aa30fb32', 'Exmo', 'Exmo 2'),
    ...
    ('0xb3aaaae47070264f3595c5032ee94b620a583a39', 'WEX Exchange', 'WEX Exchange 1'),
    ('0xd4dcd2459bb78d7a645aa7e196857d421b10d93f', 'Peatio', 'Peatio 1'),
    ...
    ('0xb9ee1e551f538a464e8f8c41e9904498505b49b0', 'CoinEx', 'CoinEx 1'),
    ('0x33ddd548fe3a082d753e5fe721a26e1ab43e3598', 'CoinEx', 'CoinEx 2'),
    ('0x4b01721f0244e7c5b5f63c20942850e447f5a5ee', 'CoinExchange', 'CoinExchange 1'),
    ...
    ('0xaeec6f5aca72f3a005af1b3420ab8c8c7009bac8', 'OTCBTC', 'OTCBTC 1'),
    ...
    ('0x2f1233ec3a4930fd95874291db7da9e90dfb2f03', 'Uex', 'Uex 1'),
    ('0x340d693ed55d7ba167d184ea76ea2fd092a35bdc', 'Uphold', 'Uphold 1'),
    ('0xea81ce54a0afa10a027f65503bd52fba83d745b8', 'Kuna.io', 'Kuna.io 1'),
    ('0x77ab999d1e9f152156b4411e1f3e2a42dab8cd6d', 'Kuna.io', 'Kuna.io 2'),
    ('0x4b729cf402cfcffd057e254924b32241aedc1795', 'Bit-Z', 'Bit-Z 1'),
    ('0x00cdc153aa8894d08207719fe921fff964f28ba3', 'Bitzlato', 'Bitzlato 1'),
    ...
    ('0x72bcfa6932feacd91cb2ea44b0731ed8ae04d0d3', 'Cashierest', 'Cashierest 1'),
    ('0xf73c3c65bde10bf26c2e1763104e609a41702efe', 'Bibox', 'Bibox 1'),
    ...
    ('0x6b59210ade46b62b25e82e95ab390a7ccadd4c3a', 'Bitberry', 'Bitberry 1'),
    ('0xa30d8157911ef23c46c0eb71889efe6a648a41f7', 'BigONE', 'BigONE 1'),
    ...
    ('0x4df5f3610e2471095a130d7d934d551f3dde01ed', 'ATAIX', 'ATAIX 1'),
    ('0xadb72986ead16bdbc99208086bd431c1aa38938e', 'Beaxy', 'Beaxy 1'),
    ('0x7a10ec7d68a048bdae36a70e93532d31423170fa', 'Bgogo', 'Bgogo 1'),
    ('0xce1bf8e51f8b39e51c6184e059786d1c0eaf360f', 'Bgogo', 'Bgogo 2'),
    ('0xf7793d27a1b76cdf14db7c83e82c772cf7c92910', 'Bilaxy', 'Bilaxy 1'),
    ('0xcce8d59affdd93be338fc77fa0a298c2cb65da59', 'Bilaxy', 'Bilaxy 2'),
    ('0xfb9f7f41319157ac5c5dccae308a63a4337ad5d9', 'Bity', 'Bity'),
    ('0xbcdfc35b86bedf72f0cda046a3c16829a2ef41d1', 'BW', 'BW Old Address'),
    ('0x73957709695e73fd175582105c44743cf0fb6f2f', 'BW', 'BW 1'),
    ('0x111cff45948819988857bbf1966a0399e0d1141e', 'bitFlyer', 'bitFlyer 1'),
    ('0x167a9333bf582556f35bd4d16a7e80e191aa6476', 'Coinone', 'Coinone 1'),
    ('0xdb044b8298e04d442fdbe5ce01b8cc8f77130e33', 'Bitkub', 'Bitkub Hot Wallet 1'),
    ('0x3d1d8a1d418220fd53c18744d44c182c46f47468', 'Bitkub', 'Bitkub Hot Wallet 2'),
    ('0x59e0cda5922efba00a57794faf09bf6252d64126', 'Bitkub', 'Bitkub Hot Wallet 3'),
    ('0x1579b5f6582c7a04f5ffeec683c13008c4b0a520', 'Bitkub', 'Bitkub Hot Wallet 4'),
    ('0x51836a753e344257b361519e948ffcaf5fb8d521', 'Indodax', 'Indodax 1'),
    ('0x9cbadd5ce7e14742f70414a6dcbd4e7bb8712719', 'Indodax', 'Indodax 2'),
    ('0x477b8d5ef7c2c42db84deb555419cd817c336b6f', 'MaiCoin', 'MaiCoin 1'),
    ('0xdf5021a4c1401f1125cd347e394d977630e17cf7', 'Bitfront', 'Bitfront 1'),
    ('0x7c49e1c0e33f3efb57d64b7690fa287c8d15b90a', 'Bit2C', 'Bit2C 1'),
    ('0x4e5b2e1dc63f6b91cb6cd759936495434c7e972f', 'FixedFloat', 'FixedFloat 1'),
    ('0x6cc8dcbca746a6e4fdefb98e1d0df903b107fd21', 'Bitrue', 'Bitrue 1'),
    ...
    ('0x007174732705604bbbf77038332dc52fd5a5000c', 'BlockTrades', 'BlockTrades 1'),
    ('0x7a56f645dcb513d0326cbaa048e9106ff6d4cd5f', 'Catex', 'Catex'),
    ('0xe03c23519e18d64f144d2800e30e81b0065c48b5', 'Mercatox', 'Mercatox 1'),
    ('0x91f6d99b232153cb655ad3e0d05e13ef505f6cd5', 'Sparrow', 'Sparrow 1'),
    ('0xe855283086fbee485aecf2084345a91424c23954', 'Sparrow', 'Sparrow 2'),
    ('0x2101e480e22c953b37b9d0fe6551c1354fe705e6', 'DMEX', 'DMEX 1'),
    ('0x5d375281582791a38e0348915fa9cbc6139e9c2a', 'BitBlinx', 'BitBlinx'),
    ('0x03e3ff995863828554282e80870b489cc31dc8bc', 'OMGFIN', 'OMGFIN'),
    ('0x521db06bf657ed1d6c98553a70319a8ddbac75a3', 'CREX24', 'CREX24 1'),
    ('0xcacc694840ecebadd9b4c419e5b7f1d73fedf999', 'Panda Exchange', 'Panda Exchange Hot Wallet 1'),
    ('0xb709d82f0706476457ae6bad7c3534fbf424382c', 'Panda Exchange', 'Panda Exchange Hot Wallet 2'),
    ('0x3c11c3025ce387d76c2eddf1493ec55a8cc2a0f7', 'IDAX', 'IDAX'),
    ('0x14301566b9669b672878d86ff0b1d18dd58054e9', 'FlataExchange', 'FlataExchange'),
    ('0xefda0cb780a8564903285ed25df3cc024f3b2982', 'XT.com Exchange', 'XT.com Exchange 1'),
    ('0x0d8824ca76e627e9cc8227faa3b3993986ce9e48', 'BitBase', 'BitBase 1'),
    ('0x6dcd15a0dbefd0700063a4445382d3506391a41a', 'BitBase', 'BitBase 2'),
    ('0x352bdabe484499e4c25c3536cc3eda1edbc5ad29', 'KickEX', 'KickEX 1'),
    ('0xaf4ff15c9809e246111802f04a6acc7160992fef', 'KickEX', 'KickEX Hot Wallet 1'),
    ('0xc153121042832ac11587ebe361b8dc3ccd90e9e4', 'KickEX', 'KickEX Cold Wallet'),
    ('0x9539e0b14021a43cde41d9d45dc34969be9c7cb0', 'Coinbene', 'Coinbene 1'),
    ('0x33683b94334eebc9bd3ea85ddbda4a86fb461405', 'Coinbene', 'Coinbene Cold Wallet 1'),
    ('0xd344539efe31f8b6de983a0cab4fb721fc69c547', 'QuantaEx', 'QuantaEx 1'),
    ('0x5ca39c42f4dee3a5ba8fec3ad4902157d48700bf', 'QuantaEx', 'QuantaEx 2'),
    ('0x2a048d9a8ffdd239f063b09854976c3049ae659c', 'QuantaEx', 'QuantaEx 3'),
    ...
    ('0x8705ccfd8a6df3785217c307cbebf9b793310b94', 'CoinW', 'CoinW 1'),
    ('0xcb243bf48fb443082fae7db47ec96cb120cd6801', 'CoinW', 'CoinW 2'),
    ('0x429bf8ec3330e02401d72beade86000d9a2e19eb', 'CoinW', 'CoinW 3'),
    ('0x6f31d347457962c9811ff953742870ef5a755de3', 'CoinW', 'CoinW 4'),
    ('0x5baeac0a0417a05733884852aa068b706967e790', 'Cryptopia', 'Cryptopia 1'),
    ('0x2984581ece53a4390d1f568673cf693139c97049', 'Cryptopia', 'Cryptopia 2'),
    ('0xbf1a97d8d4229d61b031214d5bbe9a5cb1e737f9', 'CoinDhan', 'CoinDhan 1'),
    ('0x6eff3372fa352b239bb24ff91b423a572347000d', 'BIKI', 'BIKI 1'),
    ('0x6efb20f61b80f6a7ebe7a107bace58288a51fb34', 'BIKI', 'BIKI Old Address'),
    ('0x8271b2e8cbe29396e9563229030c89679b9470db', 'Liqui', 'Liqui 1'),
    ('0x5e575279bf9f4acf0a130c186861454247394c06', 'Liqui', 'Liqui 2'),
    ...
    ('0x258b7b9a1ba92f47f5f4f5e733293477620a82cb', 'Beldex', 'Beldex 1'),
    ('0x324cc2c9fb379ea7a0d1c0862c3b48ca28d174a4', 'SouthXchange', 'SouthXchange 1'),
]


# sources:
# - https://github.com/duneanalytics/spellbook/blob/main/models/addresses/optimism/addresses_optimism_cex.sql
optimism_cexes = [
...
# sources:
# - https://github.com/duneanalytics/spellbook/blob/main/models/labels/addresses/institution/identifier/cex/labels_cex_bnb.sql
bnb_cexes = [
    ('bnb', '0x631Fc1EA2270e98fbD9D92658eCe0F5a269Aa161', 'Binance 1'),
    ('bnb', '0xB1256D6b31E4Ae87DA1D56E5890C66be7f1C038e', 'Binance 2'),
    ('bnb', '0x17B692ae403a8Ff3a3B2eD7676cF194310ddE9Af', 'Binance 3'),
    ('bnb', '0x8ff804cc2143451f454779a40de386f913dcff20', 'Binance 4'),
    ('bnb', '0xAD9ffffd4573b642959D3B854027735579555Cbc', 'Binance 5'),
    ('bnb', '0x8894e0a0c962cb723c1976a4421c95949be2d4e3', 'Binance 6'),
    ('bnb', '0xe2fc31f816a9b94326492132018c3aecc4a93ae1', 'Binance 7'),
    ('bnb', '0x3c783c21a0383057d128bae431894a5c19f9cf06', 'Binance 8'),
    ('bnb', '0xdccf3b77da55107280bd850ea519df3705d1a75a', 'Binance 9'),
    ('bnb', '0x01c952174c24e1210d26961d456a77a39e1f0bb0', 'Binance 10'),
    ('bnb', '0x161ba15a5f335c9f06bb5bbb0a9ce14076fbb645', 'Binance 11'),
    ('bnb', '0x515b72ed8a97f42c568d6a143232775018f133c8', 'Binance 12'),
    ('bnb', '0xbd612a3f30dca67bf60a39fd0d35e39b7ab80774', 'Binance 13'),
    ('bnb', '0x7a8A34DB9acD10C3b6277473b192FE47192569cA', 'Binance 14'),
    ('bnb', '0x1D40B233CdF2cC0CDC347d5401D5b02c2831A0c1', 'Binance 15'),
    ('bnb', '0xa180fe01b906a1be37be6c534a3300785b20d947', 'Binance 16'),
    ('bnb', '0x29bdfbf7d27462a2d115748ace2bd71a2646946c', 'Binance 17'),
    ('bnb', '0x73f5ebe90f27b46ea12e5795d16c4b408b19cc6f', 'Binance 18'),
    ('bnb', '0x1fbe2acee135d991592f167ac371f3dd893a508b', 'Binance 19'),
    ('bnb', '0xf977814e90da44bfa03b6295a0616a897441acec', 'Binance 20'),
    ('bnb', '0xBE0eB53F46cd790Cd13851d5EFf43D12404d33E8', 'Binance 21'),
    ('bnb', '0x5a52e96bacdabb82fd05763e25335261b270efcb', 'Binance 22'),
    ('bnb', '0xeb2d2f1b8c558a40207669291fda468e50c8a0bb', 'Binance Charity'),
    ('bnb', '0x6262998ced04146fa42253a5c0af90ca02dfd2a3', 'Crypto.com 1'),
    ('bnb', '0x46340b20830761efd32832a74d7169b29feb9758', 'Crypto.com 2'),
    ('bnb', '0x72A53cDBBcc1b9efa39c834A540550e23463AAcB', 'Crypto.com 3'),
    ('bnb', '0x7758e507850da48cd47df1fb5f875c23e3340c50', 'Crypto.com 4'),
    ('bnb', '0xcffad3200574698b78f32232aa9d63eabd290703', 'Crypto.com 5'),
]
...
def get_cex_addresses(context: spec.Context) -> pl.DataFrame:
    ...
    if chain_id == 1:
        cexes = ethereum_cexes
    elif chain_id == 10:
        cexes = optimism_cexes
    elif chain_id == 56:
        cexes = bnb_cexes
    else:
        raise Exception('cex addresses not available for network')

    return pl.DataFrame(cexes, schema=['address', 'cex', 'label'])
