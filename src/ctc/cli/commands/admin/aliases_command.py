...
aliases_help = """these aliases allow you to call ctc subcommands without typing the "ctc" part
    ...
    for example: [option]4byte 0xa9059cbb[/option] instead of [option]ctc 4byte 0xa9059cbb[/option]

these aliases must go in your shell config file

    this can be done using one of the following methods:
    1. use [option]ctc aliases --append[/option] to autodetect and append to config file
...
def aliases_command(names: bool, append: bool) -> None:
    if names:
